...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=SVsz2IbC#lF_yvLMl9dIzmHNEHb-q7mLI6AeWOZxa-MdUtbniOFY' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '923139783801' : process.env.OWNER_NUMBER,   
